...
from testcases_executor.__main__ import get_groups, check_components_type, main


class FakeTestCase(TestCase):
    """A fake unittest.TestCase to TestMain.test_check_components_type ."""
    pass
...
class TestMain(TestCase):
    ...
    def assert_check_components_type(self, groups_value, desired_result):
        """Assert if check_components return the desired result."""
        # simulate ModuleNotFoundError
        self.assertEqual(check_components_type(groups_value), desired_result)

    def test_check_components_type(self):
        """Assert check_components_type returns for component not a tuple,
        ...
        self.assert_check_components_type(
    ...
    @patch('testcases_executor.__main__.check_components_type')
